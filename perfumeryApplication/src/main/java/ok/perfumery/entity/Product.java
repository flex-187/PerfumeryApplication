...
public class Product {
	...
	public enum Type {PRODUCT_SEALED("Sealed product"),
					  PRODUCT("Unsealed product"),
					  TESTER("Tester"),
					  DECANT("Decant"),
					  SAMPLE("Sample");
	...
	public String toString() {
		...
		return String.format("id: %s name: %s, producer: %s, batch: %s, maxVol: %s, currentVol: %s, date: %s",this.getId(), this.getName(), this.getProducer(), this.getBatchCode(), this.getMaxVolume(),this.getCurrentVolume(), this.getPlacedAt()	);
	}
